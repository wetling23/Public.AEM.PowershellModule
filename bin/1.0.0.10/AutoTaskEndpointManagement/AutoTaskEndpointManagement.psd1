@{
    ...
    'Get-AemDevicesFromSite', 'Get-AemDevice', 'Get-AemJob', 'Get-AemSites', 'Get-AemSoftwareList', 'Get-AemUsers',
    ...
    PrivateData       = @{
        ...
        PSData = @{
            ...
            ReleaseNotes = 'Updated Start-AemQuickJob (1.0.0.1) for better handing of multiple component variables. Added Get-AemJob (1.0.0.1).'
