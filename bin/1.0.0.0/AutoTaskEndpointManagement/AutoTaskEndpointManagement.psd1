...
# Functions to export from this module
    FunctionsToExport = 'Find-AemSoftwareApplication',
                        'Get-AemDevicesFromSite', 'Get-AemDevices', 'Get-AemSites', 'Get-AemSoftwareList',
                        'New-AemApiTokenRequest'
