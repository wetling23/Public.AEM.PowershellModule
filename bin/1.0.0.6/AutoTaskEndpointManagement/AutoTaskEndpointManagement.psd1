@{
    ...
    'Get-AemDevicesFromSite', 'Get-AemDevice', 'Get-AemSites', 'Get-AemSoftwareList', 'Get-AemUsers',
    'New-AemApiAccessToken',
    'Set-AemDeviceUdf', 'Set-AemSiteDescription'
    ...
    PrivateData       = @{
        ...
        PSData = @{
            ...
            ReleaseNotes = 'Updates made by https://github.com/KonTheCat to include addition of Set-AemSiteDescription and Set-AemDeviceUdf, as well as renaming and update to Get-AemDevices (renamed to "Get-AemDevice").'
