@{
    ...
    'Get-AemDevicesFromSite', 'Get-AemDevice', 'Get-AemJob', 'Get-AemSite', 'Get-AemSoftwareList', 'Get-AemUser',
    ...
    PrivateData       = @{
        ...
        PSData = @{
            ...
            ReleaseNotes = 'Updated log handling. Now we support none, file, and event log'
